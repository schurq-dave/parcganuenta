  ...
  return (
    <section className="section-padding-lg bg-brand-white" aria-label="Over Parc Ganuenta">
      <div className="container-site-wide">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 pt-[100px]">
                ...
                if (cta.variant === 'primary' || cta.variant === 'accent') {
                  return (
                    <Link
                      ...
                      className="btn-group"
                    >
                      <span className={`btn ${cta.variant === 'accent' ? 'btn-accent btn-accent-light' : 'btn-primary'}`}>{cta.label}</span>
